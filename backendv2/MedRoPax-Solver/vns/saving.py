...
def saving(problem: VRP3D, insertion_mode:str, construction_mode:str, max_iteration=100 ) -> Solution:
    """
    ...
    """
    solution = greedy_initialization(problem, insertion_mode, construction_mode)
    return solution
